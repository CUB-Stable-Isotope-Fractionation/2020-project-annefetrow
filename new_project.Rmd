...
isotopes <- tibble(
              ...
              # calc isotopes for each DIC species
                d_CO2_g = 0, #permil
                d_CO2_aq = d_CO2_g + f_CA * (1 / ((-373 / T.K) + 0.19)), # Mook (1986), CO2(g) to CO2(aq)
                d_HCO3_aq = d_CO2_aq + f_bicarb * (-9866 / T.K + 24.12), # Mook (1986), CO2(aq) to HCO3
                d_CO3_aq = d_HCO3_aq + f_carb * (1 / ((-867 / T.K) + 2.52)), #Mook (1986), HCO3 to CO3
